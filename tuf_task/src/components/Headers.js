...
const Header = () => {
  ...
  return (
      <header className="cursor-pointer sticky flex container my-4 px-3 bg-black py-4 rounded-md mx-auto h-fit max-w-[1024px] items-center justify-between z-10 border-zinc-800">
        
      <div className="flex justify-center" onClick={() => navigate('/')}>
        <div className="place-self-start container ">
          <svg
            width="125"
            height="26"
            viewBox="0 0 135 36"
      ...
      <div>
        {localStorage.getItem('x-auth-token') == undefined ? <button
        ...
        >
          <span class="relative">Admin Login</span>
        </button> : <button
            onClick={() => {
