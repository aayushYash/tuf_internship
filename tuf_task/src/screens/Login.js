...
const Login = () => {
    ...
    return <div className='flex items-center justify-center'>
        ...
        <div className="min-w-[312px] h-[400px] bg-[#191919] px-8 py-10 rounded-lg">
            {/* logo */}
            <h1 class="text-[#e11d48] font-amaranth font-bold text-5xl ">takeUforward</h1>
            {/* form */}
            <form className='mt-3 py-4'>
                <InputText type={'text'} placeholder={"Email"} value={username} onChange={(e) => setUsername(e.target.value)} />
                ...
                <button className='mt-2 container py-2 bg-[#e11d48] rounded font-bold text-white uppercase space-x-1' onClick={loginHandler}>Sign In</button>
            </form>
        </div>
    </div>
}
